...
func testTXTRegistryApplyChangesWithPrefix(t *testing.T) {
	...
	changes := &plan.Changes{
		Create: []*endpoint.Endpoint{
			...
			newEndpointWithOwner("new-record-2.test-zone.example.org", "\"exampleText\"", endpoint.RecordTypeTXT, ""),
			newEndpointWithOwner("new-record-3.test-zone.example.org", "\"exampleText\"", endpoint.RecordTypeMX, ""),
	...
	expected := &plan.Changes{
		Create: []*endpoint.Endpoint{
			...
			newEndpointWithOwner("new-record-2.test-zone.example.org", "\"exampleText\"", endpoint.RecordTypeTXT, "owner"),
			newEndpointWithOwner("new-record-3.test-zone.example.org", "\"exampleText\"", endpoint.RecordTypeMX, "owner"),
			newEndpointWithOwnerAndOwnedRecord("txt.mx-new-record-3.test-zone.example.org", "\"heritage=external-dns,external-dns/owner=owner\"", endpoint.RecordTypeTXT, "", "new-record-3.test-zone.example.org"),
			...
			newEndpointWithOwnerAndOwnedRecord("txt.new-record-2.test-zone.example.org", "\"heritage=external-dns,external-dns/owner=owner,external-dns/resource=ingress/default/my-ingress\"", endpoint.RecordTypeTXT, "", "new-record-2.test-zone.example.org"),
...
func testTXTRegistryApplyChangesWithTemplatedPrefix(t *testing.T) {
	...
	changes := &plan.Changes{
		Create: []*endpoint.Endpoint{
			newEndpointWithOwnerResource("new-record-1.test-zone.example.org", "new-loadbalancer-1.lb.com", endpoint.RecordTypeCNAME, "", "ingress/default/my-ingress"),
			newEndpointWithOwnerResource("new-record-2.test-zone.example.org", "new-loadbalancer-1.lb.com", endpoint.RecordTypeMX, "", "ingress/default/my-ingress"),
			newEndpointWithOwnerResource("new-record-3.test-zone.example.org", "new-loadbalancer-1.lb.com", endpoint.RecordTypeMX, "", "ingress/default/my-ingress"),
		},
		Delete:    []*endpoint.Endpoint{},
		UpdateOld: []*endpoint.Endpoint{},
		UpdateNew: []*endpoint.Endpoint{},
	...
	expected := &plan.Changes{
		Create: []*endpoint.Endpoint{
			newEndpointWithOwnerResource("new-record-1.test-zone.example.org", "new-loadbalancer-1.lb.com", endpoint.RecordTypeCNAME, "owner", "ingress/default/my-ingress"),
			newEndpointWithOwnerResource("new-record-2.test-zone.example.org", "new-loadbalancer-1.lb.com", endpoint.RecordTypeTXT, "owner", "ingress/default/my-ingress"),
			newEndpointWithOwnerResource("new-record-3.test-zone.example.org", "new-loadbalancer-1.lb.com", endpoint.RecordTypeMX, "owner", "ingress/default/my-ingress"),
			...
			newEndpointWithOwnerAndOwnedRecord("prefixmx.new-record-2.test-zone.example.org", "\"heritage=external-dns,external-dns/owner=owner,external-dns/resource=ingress/default/my-ingress\"", endpoint.RecordTypeTXT, "", "new-record-2.test-zone.example.org"),
			newEndpointWithOwnerAndOwnedRecord("prefixmx.new-record-3.test-zone.example.org", "\"heritage=external-dns,external-dns/owner=owner,external-dns/resource=ingress/default/my-ingress\"", endpoint.RecordTypeTXT, "", "new-record-3.test-zone.example.org"),
		},
	}
	p.OnApplyChanges = func(ctx context.Context, got *plan.Changes) {
		mExpected := map[string][]*endpoint.Endpoint{
